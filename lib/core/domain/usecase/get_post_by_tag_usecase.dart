...
class GetPostByTagUsecase extends Usecase<List<PostEntity>, PaginationParams<String>> {
  final PostRepository _repository;

  GetPostByTagUsecase(this._repository);

  @override
  Future<Either<Failure,List<PostEntity>>> call(PaginationParams<String> params) {
    return _repository.getPostByTag(params);
  }
}
